...
class IDAODataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.train, self.batch_size, shuffle=True, num_workers=0, drop_last=True)

    def val_dataloader(self):
        #return DataLoader(self.val, 1, num_workers=0, shuffle=False)
        return DataLoader(self.val, self.batch_size,  shuffle=False, num_workers=0, drop_last=True)
